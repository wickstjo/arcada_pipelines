from common import cassandra_utils, redis_utils, thread_utils, misc, constants
from .funcs import types, dataset_utils
...
class pipeline_component:
    def __init__(self, structs):
        ...
        # RESET OLD DB & CACHE RESOURCES FOR FRESH EXPERIMENTS?
        if structs.global_config.pipeline.data_ingestion.historical.reset_storage:
        ...
        dataset_path: str = structs.global_config.pipeline.data_ingestion.historical.dataset
        self.dataset = dataset_utils.load_csv(dataset_path)
